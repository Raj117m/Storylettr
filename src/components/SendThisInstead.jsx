...
/**
 * Sticky taxi-yellow WhatsApp share button. Opens WhatsApp with a
...
export default function SendThisInstead({ headline, summary, url, sticky = false }) {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className={`inline-flex items-center justify-center gap-2 font-semibold text-sm px-5 py-3 rounded-full shadow-lg ${
