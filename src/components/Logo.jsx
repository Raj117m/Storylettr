...
export default function Logo({ size = 32, className = '' }) {
  return (
    <svg
      ...
      className={className}
    >
      <rect width="32" height="32" rx="8" fill="#1C3D5C" />
      <g fill="none" stroke="#C9A45C" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
        {/* letter, held below */}
        <rect x="10.5" y="18.5" width="11" height="7.5" rx="1" fill="#1C3D5C" />
        <path d="M10.5 19 L16 23 L21.5 19" />
        {/* pigeon body */}
        <path d="M8 15.5c1-3 4-5.5 7.5-5.5 4 0 7 2.8 7.7 6.3.2 1-.5 1.9-1.5 1.9H10c-1.3 0-2.3-1.3-2-2.7z" fill="#1C3D5C" />
        {/* wing */}
        <path d="M13 11c1.5-1.8 3.6-2.6 5.6-2 1.6.5 2.6 1.8 2.9 3.3" />
        {/* head + beak */}
        <circle cx="21.3" cy="10.6" r="1.9" fill="#1C3D5C" />
