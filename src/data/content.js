...
export const CONTENT = [
  // 1. Featured Curiosity Story: Today's Letter
  {
    ...
    beforeAfterBlock: {
      ...
      subtitle: 'Side-by-side empirical audit of unit economics, velocity, and compounding retention dynamics.',
      beforeLabel: 'Paid Ad Regime (Historical)',
      afterLabel: 'Referral Architecture (Post-Pivot)',
      metrics: [
        {
          ...
          trend: 'better',
          note: 'Repeat cold ad touches became unnecessary once inbound leads arrived pre-vetted by peers.',
        },
        {
          ...
          trend: 'better',
          note: 'Ad signups entered on discount hooks; referral signups entered on urgent operational workflow needs.',
        },
        {
          ...
          trend: 'better',
          note: 'Internal procurement committees waived protracted security reviews on colleague recommendation.',
        },
        {
          ...
          trend: 'better',
          note: 'Warehouse shift managers who saw the physical laminated guide registered with high purchase intent.',
        },
        {
          metric: 'Compounding & Sustainability',
          before: 'Linear (Halts on Zero Spend)',
          after: 'Exponential (Perpetual Asset)',
          delta: 'Self-Sustaining Loop',
          trend: 'better',
          note: 'Laminated operations floor guides stayed pinned to warehouse dispatch walls for over 18 months.',
        },
      ],
      keyTakeaway: 'Paid advertising purchased temporary eyeballs on a rental model. The physical milestone artifact purchased permanent operational desk presence, turning shift leads into unpaid evangelists.',
      explanation: 'Audited from anonymized Stripe billing data and CRM referral source tags (June 2024 - February 2025). [DEMO / PROTOTYPE EXAMPLE]',
    },
    devilsAdvocate: {
      headline: 'Challenge the idea before you accept it.',
      strongestCounterpoint: 'Referrals are an amplification engine, not an origination mechanism. Suresh’s business already had 3 years of stability and an 88% satisfaction rate among its initial core cohort. If an early-stage startup with an unproven product turns off advertising to rely purely on referrals, they will generate silence, not word-of-mouth.',
      whenThisMightNotWork: 'In categories with low peer-to-peer discussion density or solitary utility. If a warehouse manager or consumer solves a private problem they never discuss with colleagues, physical artifacts get discarded rather than photographed and shared.',
      whatNeedsToBeTrue: 'Two operational conditions are mandatory: (1) The user must operate within a shared professional network (e.g. logistics WhatsApp groups or trade communities); (2) The artifact must deliver genuine operational utility on the job, not branded marketing swag.',
      cannotConclude: 'StoryLettr cannot conclude that paid advertising is universally wasteful. For zero-to-one ventures with no initial brand awareness, paid ads remain the only accessible laboratory to buy early qualitative user feedback.',
    },
    experiment: {
